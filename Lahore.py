...
# Target URL
driver.get("https://www.foodpanda.pk/restaurants/new?lat=31.5203696&lng=74.35874729999999&vertical=restaurants&query=chana")
...
for container in containers:
    ...
    restaurant_data.append({
        "city": "Lahore",  # Hardcode or use dynamically for other cities
...
print("Data saved to Lahore_restaurants.csv")
