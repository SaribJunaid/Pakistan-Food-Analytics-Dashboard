...
# Target URL
driver.get("https://www.foodpanda.pk/restaurants/new?lng=71.5249154&lat=34.0151366&vertical=restaurants&query=chapli+kabab")
...
for container in containers:
    ...
    restaurant_data.append({
        "city": "Peshawar",  # Hardcode or use dynamically for other cities
...
print("Data saved to Peshawar_restaurants.csv")
