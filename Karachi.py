...
# Target URL
driver.get("https://www.foodpanda.pk/restaurants/new?lat=24.8607343&lng=67.0011364&vertical=restaurants&query=biryani")
...
for container in containers:
    ...
    restaurant_data.append({
        "city": "Karachi",  # Hardcode or use dynamically for other cities
...
print("Data saved to karachi_restaurants.csv")
